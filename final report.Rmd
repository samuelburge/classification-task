...
subtitle: "STAT 639-700"
author: "Samuel Burge, Chad Austgen (UIN: ), Skylar Liu (UIN: 727007397)"
date: "April 19, 2022"
output: pdf_document
header-includes:
...
```{r k_selection_plots, echo = FALSE, out.height='40%', fig.align='center', message=FALSE, echo=FALSE, error=FALSE, fig.caption='Silhouette and gap statistic plots for determining K clusters.'}
...
grid.arrange(kmean.sil + ylab("Avg. Silhouette") + ggtitle("") + xlab("") +
             ...
             kmean.gap + ylab("Gap statistic") + ggtitle("") + scale_x_discrete(breaks = c(1,3,5,7,9,11,13, 15)), 
             
             hclust.gap + ylab("") + ggtitle("") + scale_x_discrete(breaks = c(1,3,5,7,9,11,13, 15)),
             nrow = 3, ncol = 2)
```

```{r final_cluster_barplots, echo = FALSE, out.height = '30%', fig.align='center', fig.cap='Count of observations in each cluster for both methods.'}
par(mfrow=c(1,2))
